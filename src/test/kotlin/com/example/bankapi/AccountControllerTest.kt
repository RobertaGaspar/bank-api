...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`() {
        accountRepository.save(Account(name = "Test Create", document = "1234567891011", phone = "11999998888"))
    ...
    @Test
    fun `test find by id`() {
        val account = accountRepository.save(Account(name = "Test Create", document = "1234567891011", phone = "11999998888"))
    ...
    fun `test create account`() {
        val account = Account(name = "Test Create", document = "1234567891011", phone = "11999998888")
    ...
    fun `test update account`() {
        val account = accountRepository
            .save(Account(name = "Test Create", document = "1234567891011", phone = "11999998888"))
            .copy(name = "Updated")
        val json = ObjectMapper().writeValueAsString(account)
    ...
    fun `test create account validation error empty name`() {
        val account = Account(name = "", document = "123", phone = "99999-9999")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            .accept(MediaType.APPLICATION_JSON)
    ...
    fun `test create account validation error name should be 5 character`() {
        val account = Account(name = "test", document = "123", phone = "99999-9999")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            .accept(MediaType.APPLICATION_JSON)
    ...
    fun `test create account validation empty document`() {
        val account = Account(name = "test create", document = "", phone = "99999-9999")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            .accept(MediaType.APPLICATION_JSON)
    ...
    fun `test create account validation error document should be 11 character`() {
        val account = Account(name = "test create", document = "123", phone = "99999-9999")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            .accept(MediaType.APPLICATION_JSON)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("\$.message")
                .value("[document] deve ter no minimo 11 caracteres!"))
            .andDo(MockMvcResultHandlers.print())
    ...
    fun `test create account validation empty phone`() {
        val account = Account(name = "test create", document = "123456791011", phone = "")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            .accept(MediaType.APPLICATION_JSON)
    ...
    fun `test create account validation error phone should be 11 character`() {
        val account = Account(name = "test create", document = "123456791011", phone = "99999-9999")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            .accept(MediaType.APPLICATION_JSON)
